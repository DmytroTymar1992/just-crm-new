...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            self.stdout.write(self.style.NOTICE(f'Fetching URL: {url}'))
            ...
            if not vacancy_cards:
                self.stdout.write(self.style.WARNING('No vacancy cards found. Dumping page content for debugging...'))
                with open('work_ua_debug.html', 'w', encoding='utf-8') as f:
